...
class Trainer:
    ...
    def cross_entropy(self, seq_out, pos_ids, neg_ids):
        ...
        pos_emb = self.model.item_embeddings(pos_ids) + self.model.position_embeddings.weight
        neg_emb = self.model.item_embeddings(neg_ids) + self.model.position_embeddings.weight
        # [batch*seq_len hidden_size]`
    ...
    def iteration(self, epoch, dataloader, full_sort=False, train=True):
        ...
        if train:
            ...
            for batch in rec_data_iter:
                ...
                _, input_ids, target_pos, target_neg, _ = batch # input_ids, target_ids: [b,max_Sq]
                # loss
                reconstructed_seq = self.model.forward(input_ids)  # shape:b*max_Sq*d
